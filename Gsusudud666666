...
try:
 ...
 def SESSION(phone_number="+380945612335"):
 ...
 def ENTETE():
  ...
  print(''.rjust(40,'-'))
  print("Telegram : https://t.me/joinchat/RZra_hSSIXbG9rIloY7gwA")
  print(''.rjust(40,'-'))
  print(Fore.GREEN+"Modified by Friday13".center(40,' '))
  print(''.rjust(40,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  await PROFILER(StartBotRequest(bot='hkearn_bch_bot' ,peer='hkearn_bch_bot' , start_param='844514361'))
